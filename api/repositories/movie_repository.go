...
func (repository *MovieRepository) Create(name, sex string, birth_date time.Time) (*models.Artist, error) {
...
func (repository *MovieRepository) Update(id string, name, sex string, birth_date time.Time) (*models.Artist, error) {
	db, err := repository.GetConnection()
	if err != nil {
		return nil, err
	}
